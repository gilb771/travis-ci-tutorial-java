[![Build Status](https://travis-ci.org/gilb771/travis-ci-tutorial-java.svg?branch=master)](https://travis-ci.org/gilb771/travis-ci-tutorial-java)
[![Code Coverage](https://codecov.io/github/gilb771/travis-ci-tutorial-java/coverage.svg)](https://codecov.io/gh/gilb771/travis-ci-tutorial-java)
...
1. [Fork](https://github.com/gilb771/travis-ci-tutorial-java/fork) this Repository
2. Go to [Travis CI](http://travis-ci.com) and enable the repository
3. Fix the `README.md` badges (replacing in the URL `gilb771` with `your-github-username`) and push the changes. This should trigger a build in Travis CI!
...
[Open an Issue](https://github.com/gilb771/travis-ci-tutorial-java/issues/new)!
